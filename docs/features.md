...
- [ScriptLab - Mobile App Features](#scriptlab---mobile-app-features)
  - [📱 Application Architecture](#-application-architecture)
    - [Navigation Structure](#navigation-structure)
  - [🏠 Bottom Tab Navigation (Post-Login)](#-bottom-tab-navigation-post-login)
    - [1. **Home** 🏠](#1-home-)
    - [2. **Practice** 🎯](#2-practice-)
      - [Available Practice Exercises:](#available-practice-exercises)
    - [3. **Challenges** 🏆](#3-challenges-)
    - [4. **Learn** 📚](#4-learn-)
      - [Udemy Courses (3 Featured):](#udemy-courses-3-featured)
      - [Learning Resources (3 Links):](#learning-resources-3-links)
    - [5. **More** ⋯](#5-more-)
      - [User Profile Section:](#user-profile-section)
      - [Options Menu:](#options-menu)
  - [📄 Additional Screens (Nested Navigation)](#-additional-screens-nested-navigation)
    - [Privacy Policy Screen](#privacy-policy-screen)
    - [Connect Screen](#connect-screen)
    - [About Screen](#about-screen)
  - [📱 Application Screens](#-application-screens)
    - [1. **Sign In Screen**](#1-sign-in-screen)
    - [2. **Practice Screen (Main Menu)**](#2-practice-screen-main-menu)
      - [Available Practice Items:](#available-practice-items)
  - [🎯 Practice Exercise Screens](#-practice-exercise-screens)
    - [3. **Forms \& Inputs - User Registration Form**](#3-forms--inputs---user-registration-form)
      - [Form Fields:](#form-fields)
      - [Actions:](#actions)
    - [4. **Shopping Cart**](#4-shopping-cart)
      - [Product Catalog (8 Products):](#product-catalog-8-products)
      - [Features:](#features)
    - [5. **UI Components**](#5-ui-components)
      - [5.1 Modals (4 Types)](#51-modals-4-types)
      - [5.2 Tooltips (3 Instances)](#52-tooltips-3-instances)
      - [5.3 Tabs (3 Tabs)](#53-tabs-3-tabs)
      - [5.4 Accordion (3 Items)](#54-accordion-3-items)
      - [5.5 Carousel (4 Slides)](#55-carousel-4-slides)
      - [5.6 Toggle Switches (3 Switches)](#56-toggle-switches-3-switches)
      - [5.7 Progress Bar](#57-progress-bar)
      - [5.8 Star Rating](#58-star-rating)
    - [6. **Swipe Screen**](#6-swipe-screen)
      - [Features:](#features-1)
    - [7. **Drag Screen**](#7-drag-screen)
      - [Features:](#features-2)
    - [8. **Webview Screen**](#8-webview-screen)
      - [Features:](#features-3)
  - [🔧 Technical Stack](#-technical-stack)
  - [🎯 Test Automation Focus](#-test-automation-focus)
  - [📋 Automation Testing Scenarios](#-automation-testing-scenarios)
  ...
  - [🔄 Current Features Summary](#-current-features-summary)
